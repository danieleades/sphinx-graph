...
@pytest.mark.sphinx(testroot="missing-fingerprint", warningiserror=True, exception_on_warning=True)
...
@pytest.mark.sphinx(testroot="incorrect-fingerprint", warningiserror=True, exception_on_warning=True)
